...
def write_file(relpath, content):
    ...
    with open(path, 'w') as f:
        f.write(content)
    print(f"Wrote {relpath} ({len(content)} bytes, {content.count(chr(10))} lines)")

# ip_system.h
write_file("include/ip_system.h", """#ifndef MINI_IP_SYSTEM_H
...
#define IP_MAX_ROUNDS           256
#define IP_MAX_MESSAGE_SIZE     8192
#define IP_DEFAULT_REPETITIONS  128
